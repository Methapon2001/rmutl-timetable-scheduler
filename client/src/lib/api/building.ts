...
export const createBuilding = async (
  data: Omit<API.Building, 'id' | 'createdAt' | 'createdBy' | 'updatedAt' | 'updatedBy'>,
...
export const deleteBuilding = async (data: Pick<API.Building, 'id'>): Promise<API.Building> => {
  const userSession = await refresh();
...
export const editBuilding = async (
  data: Omit<API.Building, 'createdAt' | 'createdBy' | 'updatedAt' | 'updatedBy'>,
): Promise<API.Building> => {
  const userSession = await refresh();
